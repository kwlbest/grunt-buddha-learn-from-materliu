/*
 * grunt-buddha-learn-from-materliu
 * 
 *
 * Copyright (c) 2015 modernkk
...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('buddha_learn_from_materliu', 'Buddha\'s grace illuminates code as sunshine', function () {
